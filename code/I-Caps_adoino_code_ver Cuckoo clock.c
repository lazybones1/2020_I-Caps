...
int bird_move1 = 3; //dc moter pin for come out
int bird_move2 = 4; //dc moter pin for get in
...
void setup() {
  ...
  //DC moter
  pinMode(bird_move1, OUTPUT);
  pinMode(bird_move2, OUTPUT);
...
void head_go(){
  ...
  int angle_ver = 0;
  int angle_hor = 0;
  //must be changed! when we make prototype
